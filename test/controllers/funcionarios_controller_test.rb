...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { admissao: @funcionario.admissao, email: @funcionario.email, experiencia: @funcionario.experiencia, nome: @funcionario.nome, situacao: @funcionario.situacao, telefone: @funcionario.telefone, turno_id: @funcionario.turno_id }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { admissao: @funcionario.admissao, email: @funcionario.email, experiencia: @funcionario.experiencia, nome: @funcionario.nome, situacao: @funcionario.situacao, telefone: @funcionario.telefone, turno_id: @funcionario.turno_id }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
