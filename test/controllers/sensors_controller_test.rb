...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { localizacao: @sensor.localizacao, marca: @sensor.marca, modelo: @sensor.modelo, quantidade: @sensor.quantidade }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { localizacao: @sensor.localizacao, marca: @sensor.marca, modelo: @sensor.modelo, quantidade: @sensor.quantidade }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
